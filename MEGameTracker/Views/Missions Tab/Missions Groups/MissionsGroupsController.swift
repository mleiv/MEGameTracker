...
extension MissionsGroupsController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        segue.destination.find(controllerType: MissionsSplitViewController.self) {
            (controller: MissionsSplitViewController) in
...
extension MissionsGroupsController {
    ...
    func setupTableCustomCells() {
        ...
        tableView.register(UINib(nibName: "MissionsGroupRow", bundle: bundle), forCellReuseIdentifier: "MissionsGroupRow")
...
extension MissionsGroupsController {
    ...
    func setupSearch() {
        ...
        searchManager = MESearchManager(controller: self, tempSearchBar: tempSearchBar, resultsController: resultsController, searchData: searchMissions, closeSearch: closeSearch)
