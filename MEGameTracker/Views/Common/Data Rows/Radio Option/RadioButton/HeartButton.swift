...
@IBDesignable final public class HeartButton: RadioButton {
    ...
    static let uncheckedAltImage = UIImage(named: "Hollow Heart Empty", in: Bundle(for: HeartButton.self), compatibleWith: nil)
    static let checkedAltImage = UIImage(named: "Hollow Heart Filled", in: Bundle(for: HeartButton.self), compatibleWith: nil)
