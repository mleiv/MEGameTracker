...
public struct ShepardOriginRowType: ValueDataRowType {
    ...
    public var value: String? { return UIWindow.isInterfaceBuilder ? "Earthborn" : controller?.shepard?.origin.stringValue }
