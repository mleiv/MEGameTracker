...
public protocol TabGroupsControllable: class, UIPageViewControllerDataSource, UIPageViewControllerDelegate {//, UINavigationControllerDelegate {
    ...
    func handleTabsPageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController?
    func handleTabsPageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController?
    func handleTabsPageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool)
...
extension TabGroupsControllable where Self: UIViewController {
    ...
    func setupTabsPageViewController() {
        ...
        tabsPageViewController.view.leadingAnchor.constraint(equalTo: tabsContentWrapper.leadingAnchor).isActive = true
        tabsPageViewController.view.trailingAnchor.constraint(equalTo: tabsContentWrapper.trailingAnchor).isActive = true
        tabsPageViewController.view.topAnchor.constraint(equalTo: tabsContentWrapper.topAnchor).isActive = true
        tabsPageViewController.view.bottomAnchor.constraint(equalTo: tabsContentWrapper.bottomAnchor).isActive = true
        self.tabsPageViewController = tabsPageViewController
    }

    public func handleTabsPageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
    ...
    public func handleTabsPageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
    ...
    public func handleTabsPageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
