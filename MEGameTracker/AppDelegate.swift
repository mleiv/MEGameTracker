...
extension AppDelegate {
    func applicationOpen(application: UIApplication) {
        ...
        ShepardFlowController.appInit = true // TODO: Do we even need this anymore?
...
extension AppDelegate {
    ...
    func initializeData(application: UIApplication) {
        ...
        initializeCoreData(application: application, spinnerUpdateProgressBlock: spinnerUpdateProgressBlock) { [weak self] in
...
extension AppDelegate {
    ...
    func initializeCloudKit(
        ...
        GamesDataBackup.current.sync(appState: .start, qualityOfService: .userInitiated) { [weak self] (isSynced: Bool) in
