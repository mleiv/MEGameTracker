...
public struct IBStyles {
    ...
    /// - backgroundGradient: see IBGradient. Example: IBGradient(direction:.Vertical, colors:[UIColor.red,UIColor.black])
    /// - borderColor: UIColor
    /// - borderWidth: Double
    /// - buttonImage: UIImage?
    /// - cornerRadius: Double
    ...
    public enum Property {
        ...
        public static func sort(_ a: Property, b: Property) -> Bool {
    ...
    fileprivate static func validate(_ properties: IBStyles.Properties) {
        for (type,value) in properties{
            switch (type){
                ...
                case .borderColor: assert(value as? UIColor != nil)
                case .borderWidth: assert(value as? Double != nil)
                case .buttonImage: assert(value as? UIImage != nil)
                case .cornerRadius: assert(value as? Double != nil)
                case .font: assert(value as? IBFont != nil)
                case .hasAdjustableFontSize: assert(value as? Bool != nil)
                case .padding:
                ...
                case .stateSelected:
                    assert(value as? IBStyles.Properties != nil)
                    validate(value as! IBStyles.Properties)
                case .textAlign: assert(value as? NSTextAlignment != nil)
                ...
                case .padding:
                    if var list = value as? [FloatLiteralType] {
                        ...
                        if let button = element as? UIButton {
                            button.contentEdgeInsets = UIEdgeInsets(top: CGFloat(list[0]), left: CGFloat(list[1]), bottom: CGFloat(list[2]), right: CGFloat(list[3]))
                        }
                        if let textField = element as? UITextField {
                            let leftPadding = UIView(frame: CGRect(x: 0.0, y: 0.0, width: CGFloat(list[1]), height: textField.bounds.height))
                            textField.leftView = leftPadding
                            textField.leftViewMode = .always
                        }
                        if let textView = element as? UITextView {
                            textView.textContainerInset = UIEdgeInsets(top: CGFloat(list[0]), left: CGFloat(list[1]), bottom: CGFloat(list[2]), right: CGFloat(list[3]))
                        }
                    }
...
//extension UIButton: UIContentFontSettable {
//    public var fontProperty: UIFont? {
...
//extension UIButton: UIContentColorSettable {
//    public var colorProperty: UIColor? {
...
extension IBStyles.Property: Hashable {
    public var hashValue: Int {
        switch (self) {
        case (.custom(let v1)): return v1.hashValue
        default: return "\(self)".hashValue
        }
    }
}
...
//extension UIButton: UIContentTextAlignable {
//    public var textAlignmentProperty: NSTextAlignment? {
//        get {
//            switch contentHorizontalAlignment {
//            case .left: return .left
//            case .right: return .right
//            case .fill: return .justified
//            default: return .center
//            }
//        }
//        set {
//            switch newValue ?? .center {
//            case .left: contentHorizontalAlignment = .left
//            case .right: contentHorizontalAlignment = .right
//            case .justified: contentHorizontalAlignment = .fill
//            default: contentHorizontalAlignment = .center
//            }
//        }
//    }
//}
...
public func ==(a: IBStyles.Property, b: IBStyles.Property) -> Bool {
    switch (a,b) {
    case (.custom(let v1), .custom(let v2)): return v1 == v2
    default: return "\(a)" == "\(b)"
    }
}
