...
public struct IBFont {
    ...
    public func bold() -> IBFont {
        switch style {
            case .normal: return IBFont(style: .medium, size: size)
            case .italic: return IBFont(style: .mediumItalic, size: size)
            case .medium: return IBFont(style: .semiBold, size: size)
            case .mediumItalic: return IBFont(style: .boldItalic, size: size)
            case .semiBold: return IBFont(style: .bold, size: size)
            case .semiBoldItalic: return IBFont(style: .boldItalic, size: size)
            case .bold: return IBFont(style: .bold, size: size)
            case .boldItalic: return IBFont(style: .boldItalic, size: size)
        }
    }
    ...
    public func italic() -> IBFont {
        switch style {
            ...
            case .italic: return IBFont(style: .italic, size: size)
            case .medium: fallthrough
            case .mediumItalic: return IBFont(style: .mediumItalic, size: size)
            case .semiBold: fallthrough
            case .semiBoldItalic: return IBFont(style: .semiBoldItalic, size: size)
