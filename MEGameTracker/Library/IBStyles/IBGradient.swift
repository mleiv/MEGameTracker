...
final public class IBGradientView: UIView {
	...
	/// Changes the .layer property of the view to be CAGradientLayer. 
	/// But we still have to change all interactions with .layer to recognize this new type, hence the other functions.
	///
	...
	/// Sets the locations of the gradient. See CAGradientLayer documentation for how this work, 
	///	because I only used endPoint myself.
	...
	/// Sets the start point of the gradient (this is the simplest way to define a gradient: setting start/end point)
	/// 
	...
	/// Sets the end point of the gradient (this is the simplest way to define a gradient: setting start/end point)
	/// 
