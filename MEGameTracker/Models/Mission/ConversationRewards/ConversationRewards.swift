...
// MARK: Types
    ...
    public typealias FlatDataOption = (id: String?, type: ConversationRewardType, points: String, context: String?, trigger: String, isSelected: Bool)
    public typealias FlatData = (level: Int, commonContext: String?, options: [ConversationRewards.FlatDataOption])
