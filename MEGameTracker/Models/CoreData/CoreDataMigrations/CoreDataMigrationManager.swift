...
public struct CoreDataMigrationManager {
    ...
    public let migrationsAvailable: [Int: CoreDataMigration] = [ // Int is just for easier reference when editing
        1: CoreDataMigration(fromBuild: 43, loadMigration: { return BaseDataImport() }),
...
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameDecisions.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Decision.delete(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Decision.entityName, identifier: Decision.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
//        deletedRows += GameSequence.getAllIdentifiers(ofType: Event.self) { fetchRequest in
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameEvents.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Event.delete(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Event.entityName, identifier: Event.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
//        deletedRows += GameSequence.getAllIdentifiers(ofType: Item.self) { fetchRequest in
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameItems.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Item.delete(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Item.entityName, identifier: Item.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
//        deletedRows += GameSequence.getAllIdentifiers(ofType: Map.self) { fetchRequest in
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameMaps.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Map.delete(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Map.entityName, identifier: Map.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
//        deletedRows += GameSequence.getAllIdentifiers(ofType: Mission.self) { fetchRequest in
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameMissions.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Mission.delete(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Mission.entityName, identifier: Mission.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
//        deletedRows += GameSequence.getAllIdentifiers(ofType: Note.self) { fetchRequest in
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameNotes.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Note.delete(uuid: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Note.entityName, identifier: Note.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
//        deletedRows += GameSequence.getAllIdentifiers(ofType: Shepard.self) { fetchRequest in
//            fetchRequest.predicate = NSPredicate(format: "!(%K in %@)", #keyPath(GameShepards.gameSequenceUuid), gameIds)
//        }.map {
//            _ = Shepard.delete(uuid: $0.id, gameSequenceUuid: $0.gameSequenceUuid)
//            return DeletedRow(source: Shepard.entityName, identifier: Shepard.getIdentifyingName(id: $0.id, gameSequenceUuid: $0.gameSequenceUuid))
//        }
//        
