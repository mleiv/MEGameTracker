...
struct CoreDataManager2: CodableCoreDataManageable {

    public static let defaultStoreName = "CoreData"

    public static var current: CodableCoreDataManageable = CoreDataManager2(storeName: defaultStoreName)
    ...
    public init() {
        self.init(storeName: CoreDataManager2.defaultStoreName)
    }
    ...
    public init(storeName: String?, context: NSManagedObjectContext?, isConfineToMemoryStore: Bool) {
        ...
        self.storeName = storeName ?? CoreDataManager2.defaultStoreName
        ...
        if let storeName = storeName {
            ...
            persistentContainer = CoreDataManager2.current.persistentContainer
        }
    }
...
extension CodableCoreDataStorable {
    public static var defaultManager: CodableCoreDataManageable {
        return CoreDataManager2.current
    }
}
