...
// MARK: Get Existing Only
    ...
    public static func getExisting(
        ...
        return getAllExisting(ids: ids, gameSequenceUuid: gameSequenceUuid, with: manager, alterFetchRequest: alterFetchRequest).first
    }
    
    /// Convenience version of getExisting:id:gameSequenceUuid:manager:alterFetchRequest (no id, manager, alterFetchRequest required).
    public static func getExisting(
        gameSequenceUuid: String?,
        with manager: SimpleSerializedCoreDataManageable? = nil,
        alterFetchRequest: @escaping AlterFetchRequest<EntityType> = { _ in }
    ) -> Self? {
        return getExisting(id: nil, gameSequenceUuid: gameSequenceUuid, with: manager, alterFetchRequest: alterFetchRequest)
    }
    ...
    public static func getAllExisting(
        ...
        return getAllExisting(ids: [], gameSequenceUuid: gameSequenceUuid, with: manager, alterFetchRequest: alterFetchRequest)
    }
    
    /// Convenience version of getAllExisting:id:gameSequenceUuid:manager:alterFetchRequest (no manager, alterFetchRequest required).
    public static func getAllExisting(
        ids: [String],
        gameSequenceUuid: String? = nil,
        with manager: SimpleSerializedCoreDataManageable? = nil
    ...
    /// Convenience version of getAllExisting:id:gameSequenceUuid:manager:alterFetchRequest (no manager, parameters required).
    public static func getAllExisting(
        with manager: SimpleSerializedCoreDataManageable? = nil,
        alterFetchRequest: @escaping AlterFetchRequest<EntityType> = { _ in }
    ) -> [Self] {
