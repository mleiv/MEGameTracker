...
final class Change20170305Tests: MEGameTrackerTests {
	...
	let missionFrom = "{\"id\": \"M3.0.Citadel1\",\"gameVersion\": \"3\",\"missionType\": \"Mission\",\"conversationRewards\": [{\"set\": {\"context\": \"Recruiting Dr. Michel\",\"isExclusiveSet\": true,\"options\": [{\"id\": \"M3.0.Citadel1.P4\",\"type\": \"Paragon\",\"value\": 2,\"trigger\": \"\\\"Save billions, not hundreds.\\\"\"}, {\"id\": \"M3.0.Citadel1.R4\",\"type\": \"Renegade\",\"value\": 2,\"trigger\": \"\\\"Our mission is more important.\\\"\"}]}}, {\"context\": \"Visiting Ashley\\/Kaidan at the hospital\",\"id\": \"M3.0.Citadel1.PR5\",\"type\": \"Paragade\",\"value\": 2,\"trigger\": \"(Automatic.)\"}, {\"set\": {\"context\": \"Speaking to Bailey at office\",\"isExclusiveSet\": true,\"options\": [{\"id\": \"M3.0.Citadel1.P6\",\"type\": \"Paragon\",\"value\": 2,\"trigger\": \"\\\"Bear with it.\\\"\"}, {\"id\": \"M3.0.Citadel1.R6\",\"type\": \"Renegade\",\"value\": 2,\"trigger\": \"(Automatic)\"}]}}]}"

	let ashleyConvo = "{\"id\": \"A3.Convo.S.Ashley\",\"gameVersion\": \"3\",\"missionType\": \"Conversation\",\"conversationRewards\": [{\"context\": \"Visiting Ashley at the hospital (during Citadel I)\",\"id\": \"A3.Convo.S.Ashley.P1\",\"type\": \"Paragade\",\"value\": 2,\"trigger\": \"(Automatic)\"}]}"

	let kaidanConvo = "{\"id\": \"A3.Convo.S.Kaidan\",\"gameVersion\": \"3\",\"missionType\": \"Conversation\",\"conversationRewards\": [{\"context\": \"Visiting Kaidan at the hospital (during Citadel I)\",\"id\": \"A3.Convo.S.Kaidan.P1\",\"type\": \"Paragade\",\"value\": 2,\"trigger\": \"(Automatic)\"}]}"
