...
final class MissionTests: MEGameTrackerTests {
    ...
    func testSort() {
        ...
        XCTAssert(matches1[0].id == "M1.Garrus", "Failed to sort mission 1 correctly")
        XCTAssert(matches1[1].id == "A1.UC.TurianInsignias", "Failed to sort mission 2 correctly")
        XCTAssert(matches1[2].id == "A2.N7.ArcheologicalDig", "Failed to sort mission 3 correctly")
    }
    ...
    func testGetByGameVersion() {
        ...
        XCTAssert(mission?.isAvailable == false, "Failed to make mission unavailable in game version")
    ...
    func testChange() {
        ...
        XCTAssert(mission?.isCompleted == false, "Reported incorrect initial mission state")
        ...
        XCTAssert(mission?.isCompleted == true, "Reported incorrect completed mission state")
    ...
    func testCompleteObjectives() {
        ...
        mission = Mission.get(id: "M1.Garrus")
        XCTAssert(mission?.isCompleted == true, "Failed to complete mission when all mission objectives completed")
        ...
        mission = Mission.get(id: "M1.Garrus")
        XCTAssert(mission?.isCompleted == false, "Failed to uncomplete mission when a mission objective uncompleted")
        ...
        XCTAssert(objective1?.isCompleted == true, "Failed to complete objective when mission completed")
        ...
        objective1 = Mission.get(id: "M1.Garrus.1")
        XCTAssert(objective1?.isCompleted == true, "Incorrectly uncompleted objective when mission uncompleted")
    }
    ...
    func testCompleteLimitedObjectives() {
        ...
        XCTAssert(mission?.isCompleted == true, "Failed to complete mission when max necessary mission objectives completed")
        ...
        mission = Mission.get(id: "A1.UC.TurianInsignias")
        XCTAssert(mission?.isCompleted == false, "Failed to uncomplete mission when a max necessary mission objective uncompleted")
        ...
        XCTAssert(objective3?.isAcquired == false, "Incorrectly completed objective when mission completed")
        ...
        XCTAssert(objective1?.isAcquired == true, "Incorrectly uncompleted objective when mission uncompleted")
    }
